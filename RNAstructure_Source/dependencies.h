...
ifneq ($(CUDA),)
CUDA_RNA_FILES = \
	${ROOTPATH}/fold-smp/frna.o \
	${ROOTPATH}/fold-smp/fparam.o \
	${ROOTPATH}/partition-smp/prna.o \
	${ROOTPATH}/partition-smp/base.o \
	${ROOTPATH}/partition-smp/param.o \
	${ROOTPATH}/partition-smp/util.o
else
CUDA_RNA_FILES=
endif

#	${ROOTPATH}/fold-smp/base.o \
#	${ROOTPATH}/fold-smp/util.o \

# Common files for the RNA library.
RNA_FILES = \
	${ROOTPATH}/RNA_class/RNA.o \
	${ROOTPATH}/RNA_class/thermodynamics.o \
	${ROOTPATH}/RNA_class/design.o \
...
# Updates to this list may be manually necessary if macros change or the Java drawing proxies change.
SWIG_OUT=${ROOTPATH}/java_interface/SWIG
JAVA_SWIG_FILES = \
...
${ROOTPATH}/design/design_interface.o: \
	${ROOTPATH}/design/design_interface.cpp ${ROOTPATH}/design/design_interface.h \

${ROOTPATH}/RNA_class/design.o: \
	${ROOTPATH}/RNA_class/design.cpp ${ROOTPATH}/RNA_class/design.h \
	${ROOTPATH}/RNA_class/RNA.h \
	${ROOTPATH}/RNA_class/design.h \
	${ROOTPATH}/RNA_class/thermodynamics.h \
	${ROOTPATH}/src/ErrorChecker.h \
...
${ROOTPATH}/src/loop_utils.o: \
	${ROOTPATH}/src/loop_utils.cpp ${ROOTPATH}/src/loop_utils.h
...
${ROOTPATH}/fold-smp/frna.o:
	${COMPILE_CUDA} ${ROOTPATH}/fold-smp/frna.cu

${ROOTPATH}/fold-smp/fparam.o:
	${COMPILE_CUDA} ${ROOTPATH}/fold-smp/fparam.c

#${ROOTPATH}/fold-smp/base.o:
#	${COMPILE_CUDA} ${ROOTPATH}/fold-smp/base.c

#${ROOTPATH}/fold-smp/util.o:
#	${COMPILE_CUDA} ${ROOTPATH}/fold-smp/util.c

${ROOTPATH}/fold-smp/main.o:
	${COMPILE_CUDA} ${ROOTPATH}/fold-smp/main.c

${ROOTPATH}/partition-smp/prna.o:
	${COMPILE_CUDA} ${ROOTPATH}/partition-smp/prna.cu

${ROOTPATH}/partition-smp/param.o:
	${COMPILE_CUDA} ${ROOTPATH}/partition-smp/param.c

${ROOTPATH}/partition-smp/base.o:
	${COMPILE_CUDA} ${ROOTPATH}/partition-smp/base.c

${ROOTPATH}/partition-smp/util.o:
	${COMPILE_CUDA} ${ROOTPATH}/partition-smp/util.c

${ROOTPATH}/partition-smp/main.o:
	${COMPILE_CUDA} ${ROOTPATH}/partition-smp/main.c
