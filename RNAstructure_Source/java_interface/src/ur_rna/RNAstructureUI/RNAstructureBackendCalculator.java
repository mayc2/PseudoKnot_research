...
public class RNAstructureBackendCalculator {
  ...
  public void addTurboFoldTuple(String seqFile, String ctFile) {
    RNAstructureBackendCalculatorProxyJNI.RNAstructureBackendCalculator_addTurboFoldTuple(swigCPtr, this, seqFile, ctFile);
  }
  ...
  public String runTurboFoldMaximumExpectedAccuracy(double turboGamma, int turboIterations, double percent, int structures, int window, double meaGamma) {
    return RNAstructureBackendCalculatorProxyJNI.RNAstructureBackendCalculator_runTurboFoldMaximumExpectedAccuracy(swigCPtr, this, turboGamma, turboIterations, percent, structures, window, meaGamma);
  }

  public String runTurboFoldPseudoknot(double turboGamma, int turboIterations, int pkIterations, int helix) {
    return RNAstructureBackendCalculatorProxyJNI.RNAstructureBackendCalculator_runTurboFoldPseudoknot(swigCPtr, this, turboGamma, turboIterations, pkIterations, helix);
  }

  public String runTurboFoldThreshold(double turboGamma, int turboIterations, double threshold) {
    return RNAstructureBackendCalculatorProxyJNI.RNAstructureBackendCalculator_runTurboFoldThreshold(swigCPtr, this, turboGamma, turboIterations, threshold);
  }
