...
public class FileFilters {
	...
	public static String Dynalign="Dynalign Save|dsv|";

	/*	 * Select a folding save file. */
	public static String Folding="Folding Save|sav;save|";
	...
	public static String Partition="Partition Function Save|pfs|";
	...
	public static String Sequence="FASTA|fasta|Sequence|seq|";
