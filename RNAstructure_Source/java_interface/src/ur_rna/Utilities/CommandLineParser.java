...
public class CommandLineParser {
    ...
    public void addFlagAlias(final String existingName, final String alias) {
        ...
        if (existingName == null)
            throw new IllegalArgumentException(ObjTools.fmt("No flag has been defined with the name '%s'.", existingName));
        addFlagAlias(f, alias);
    }
    public void addFlagAlias(final FlagDef f, final String alias) {
        ...
        if (other != null && other != f)
            throw new KeyAlreadyExistsException(ObjTools.fmt("The alias '%s' is already associated with the %s flag.", alias, other.name))
